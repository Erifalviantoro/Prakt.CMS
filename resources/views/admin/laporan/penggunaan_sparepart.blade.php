        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 border-b border-gray-200 pb-5">
            <div class="flex items-start gap-4">
                ...
                <div class="bg-slate-800 text-white p-3 rounded-xl shadow-md print:hidden">
                    <span class="material-symbols-outlined text-3xl block">build_circle</span>
                </div>
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 tracking-tight">
                        Laporan Audit Penggunaan Sparepart
                    </h2>
                    <p class="text-sm text-slate-500 mt-1 flex items-center gap-1">
                        <span class="material-symbols-outlined text-xs">info</span>
                        Catatan total komponen terpasang pada kendaraan pelanggan beserta rekonsiliasi biaya subtotal.
                    </p>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-700 text-slate-100 print:bg-slate-100 print:text-black">
                        <tr>
                            ...
                            <th class="px-6 py-4 font-semibold">LOG SERVIS CODE</th>
                            <th class="px-6 py-4 font-semibold">NAMA SUKU CADANG / SPAREPART</th>
                            <th class="px-6 py-4 font-semibold text-center w-36">VOLUME KELUAR</th>
                            <th class="px-6 py-4 font-semibold">SUBTOTAL BIAYA</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100 text-slate-600">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors print:hover:bg-transparent">
                            ...
                            <td class="px-6 py-4">
                                <span class="font-mono font-bold text-slate-700">#SRV-{{ $item->detail_servis_id }}</span>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center text-slate-400">
                                ...
                                Belum ada berkas transaksi pengeluaran material suku cadang.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
